...
2. The highest cost values is 47.23834.
3. It seems that the lower cost values occur in the eastern area of Tasmania, with cost values increasing as you move to the west. The highest cost values appear to occur in the northern area.  
...
```
**Answers**
1. The 13th vegetation class seems to be found in the eastern part of the study area, particularly in the norteast. 
2. 0.015 
3. From looking at the sum of all the cells for each layer, vegetation class 2 is the most abundant, present in 819 cells. 
...
1. 19.1165 km^2
2. vegetation.3
3. 6 features have a total abundance greater than 100 km^2.
...
2. 17
3. 18 
4. Based on the plot between total abundance and relative_held, a relationship is hard to determine. There are two instances where values of less than 0.4 relative_held corresponds to really high values of total abundance. Overall there does not seem to be a clear relationship at all. 
...
**Answers**
1. 15
2. There does not seem to be an obvious pattern of the priority areas. There is only one in the south area of the plot, and overall the other priority areas are pretty scattered. 
3. ?
...
**Answers**
1. $6711.58 and $8017.98. The 5th solution costs more because it covers more area so as to promote connectivity. 
2. 
3. 
